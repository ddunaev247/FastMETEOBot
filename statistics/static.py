...
def statistics_queries():
    list_days = []
    list_count = []
    queries_count = db.session.query(Queries.year, Queries.month, Queries.day, db.func.count()).group_by(Queries.day).all()
